...
def extract_json_object(text: str) -> Optional[str]:
    ...
    Skips USB CDC banners and brace-looking junk. String-aware depth scan.
    Does not invent payloads.
    """
    if not text:
        return None
    pos = 0
...
class GrokLinkClient:
    ...
    def call(self, cmd: str, **kwargs: Any) -> dict[str, Any]:
        ...
        while time.monotonic() < deadline:
            ...
            if isinstance(parsed, dict):
                return parsed
        raise TimeoutError(f"RPC JSON timeout after {rx_timeout}s last={last_raw[:160]!r}")
    ...
    def skill_status(self) -> dict[str, Any]:
        return self.call("skill_status")

    def skill_scan(self) -> dict[str, Any]:
        return self.call("skill_scan")

    def skill_unload(self, skill_id: str) -> dict[str, Any]:
        return self.call("skill_unload", id=skill_id)

    def storage_status(self) -> dict[str, Any]:
        return self.call("storage_status")

    def ble_status(self) -> dict[str, Any]:
        return self.call("ble_status")

    def spectrum_status(self) -> dict[str, Any]:
        return self.call("spectrum_status")

    def power_status(self) -> dict[str, Any]:
        return self.call("power_status")
    ...
    def resume_save(self, mission_id: str = "") -> dict[str, Any]:
        if mission_id:
            return self.call("resume_save", id=mission_id)
        return self.call("resume_save")

    def resume_load(self, mission_id: str) -> dict[str, Any]:
        return self.call("resume_load", id=mission_id)

    def vault_tail(self, n: int = 8) -> dict[str, Any]:
        return self.call("vault_tail", n=int(n))

    def vault_status(self) -> dict[str, Any]:
        return self.call("vault_status")

    def vault_flush(self) -> dict[str, Any]:
        return self.call("vault_flush")

    def vault_seal(self, secret: str) -> dict[str, Any]:
        return self.call("vault_seal", secret=secret)

    def vault_unseal(self, secret: str) -> dict[str, Any]:
        return self.call("vault_unseal", secret=secret)
