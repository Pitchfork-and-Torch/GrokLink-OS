...
(function () {
  ...
  var WIZARD = [
    ...
    },
    {
      ...
      tips: ['App CDC identity: VID_0483 / PID_5740 product GrokLink OS.', 'GrokRPC JSON API 7.'],
    },
    {
  ...
  var ROADMAP = [
    ...
    },
    {
      ...
      title: 'Field Card',
      items: [
        'GLKFS remount on a card image (host/CI)',
        'Device SD probe: absent without a card',
        'BLE skeleton (not a phone app)',
        'Bench Desktop observe-only + USB soak + host CI',
        'Host Ed25519 GLKSIG1-ED25519 (device keeps FNV)',
      ],
    },
    {
      ver: 'v3.9.1',
      status: 'shipped',
      title: 'Host/CI honesty',
      items: [
        'GLKFS CRC-on-read; table CRC fail stays corrupt',
        'Streaming append; rewrite reuses extent',
        'Honest SD probe (host_sim / no_card); never a fake RAM disk',
        'BLE tick no-op; tx/advertising/ipcc false',
        'PC bridge skips USB banners; Bench fails closed',
        'Device DFU not recut (last packaged OsRadio v3.8.0)',
      ],
    },
  ];
