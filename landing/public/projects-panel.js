 ...
 *
 * v11 - Bias Noticer landing + quieter on music site + SkyCache + SafeDeposit
 */
(function () {
  'use strict';
  ...
  var PROJECTS = [
    {
      id: 'skycache',
      name: 'SkyCache',
      blurb: 'Orbit -> offline knowledge + village mesh',
      url: 'https://skycache.jonbailey.xyz/',
      isHere: function (h) {
        return /^skycache\.jonbailey\.xyz$/i.test(h) || /skycache-jonbailey/i.test(h);
      },
    },
    {
      id: 'music',
    ...
    },
    {
      id: 'groklink',
      name: 'GrokLink OS',
      blurb: 'Native multi-radio RTOS (v3.8 storage+skills)',
      ...
      },
    {
      id: 'safedeposit',
      name: 'SafeDeposit',
      blurb: 'Source-protected vault',
      url: 'https://safedepositbox.org/',
      isHere: function (h) {
        return /(^|\.)safedepositbox\.org$/i.test(h)
          || /^safedeposit\./i.test(h);
      },
    },
    },
    {
