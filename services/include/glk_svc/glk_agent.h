...
/**
 * Crash-safe resume token on storage: state/mission_<id>.resume
 * Format: GLKRES1 id=.. pc=.. state=.. pulses=..
 */
...
/** Power-aware: defer autonomous re-arm when battery low or deep_sleep mode. */
