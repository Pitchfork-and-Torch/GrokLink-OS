...
## Current state (2026-08-01) - v3.8.0
...
```
 LLM tools (OpenAI / Claude / Grok / ...)  +  localhost :8741
         ...
         bridge/groklink_os (observe  |  RPC  |  craft)
           TCP host-sim :7341  â”‚  USB CDC serial 230400
                    â”‚
...
| SDMMC / SPI SD on device | GLKFS bind + SD probe (absent without card) | **Done (3.9 host proof; device probe)** |
