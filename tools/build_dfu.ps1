...
function Add-OsCoreSources {
  ...
  # v3.8 storage API (host FS full fidelity; device bare-metal stays ABSENT via nosys stubs)
...
if ($Profile -eq "Bringup") {
  ...
  $outBase = "GrokLink-OS-v3.8.0-radio"
  $label = "GrokLink OS 3.8.0 field research"
  $version = "3.8.0-radio"
  ...
  $outBase = "GrokLink-OS-v3.8.0-rpc"
  $label = "GrokLink OS 3.8.0 RPC"
  $version = "3.8.0-rpc"
  $commonFlags += $deviceBudget
}
