...
#define GLK_VERSION_MINOR 8
#define GLK_VERSION_PATCH 0
#define GLK_VERSION_STRING "3.8.0"
...
/** RPC API generation (bridge compatibility) - 6: storage/skills/vault/planner */
#define GLK_RPC_API 6
...
#define GLK_SPECTRUM_DUTY_MAX_MS 12000u
#endif
