...
description: >
  ...
  native GrokLink OS 3.9.1 host/CI (Field Card track; DFU not recut) with USB-stable GrokRPC, GLKFS/storage-backed skills/vault,
  calibrated observations, and owned-lab codec.
  Triggers: /groklink-os, "lab beacon", "GLK1", "rolling code education",
  "observe signals", "noise floor", "signal world", "flash groklink".
metadata:
  short-description: "GrokLink OS bridge + lab codec education (v3.9.1 host/CI)"
