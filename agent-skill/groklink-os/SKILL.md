...
description: >
  ...
  native GrokLink OS 3.9 Field Card with USB-stable GrokRPC, GLKFS/storage-backed skills/vault,
...
metadata:
  short-description: "GrokLink OS bridge + lab codec education (v3.8)"
