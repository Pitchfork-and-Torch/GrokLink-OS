...
[![Live](https://img.shields.io/badge/live-groklink.jonbailey.xyz-00e5a0)](https://groklink.jonbailey.xyz/)
[![License: MIT](https://img.shields.io/badge/License-MIT-cyan.svg)](LICENSE)
[![Version](https://img.shields.io/badge/version-3.9.1-blue.svg)](VERSION)
...
## Latest: v3.9.1 - host/CI honesty

Public cut is **host/CI honesty**. GLKFS file CRC, streaming append, honest SD probe, BLE tick no-op, PC bridge skips USB banners. Bench fails closed without hanging a TUI.

This tag does **not** recut DFU. Last packaged OsRadio is `GrokLink-OS-v3.8.0-radio.dfu`. v3.9.0 named a v3.9.0 DFU path but did not attach one. Device silicon stays at the last human flash.

See [release-notes-v3.9.1.md](release-notes-v3.9.1.md). Field Card track: [release-notes-v3.9.0.md](release-notes-v3.9.0.md).

## v3.8.0 - Storage, Skills & Persistent Autonomy
...
<p align="center">
  <img src="docs/assets/product-infographic.png" alt="GrokLink OS 3.9.1 host/CI honesty product infographic" width="100%"/>
</p>

<p align="center">
  <img src="docs/assets/architecture-infographic.jpg" alt="GrokLink OS 3.9.1 host/CI honesty architecture" width="100%"/>
</p>
...
# 3.9.1 does not recut DFU. Human-gated: tools\build_dfu.ps1 -Profile OsRadio
