...
## Latest: v3.9.0 - Field Card

GLKFS remount on a card image (host/CI). Device SD probe stays **absent** without a card. BLE `ble_status` is a skeleton. Bench Desktop is observe-only. USB soak + host CI. API **7**.

See [release-notes-v3.9.0.md](release-notes-v3.9.0.md). Built on v3.8 storage/skills/vault.
...
<p align="center">
  <img src="docs/assets/product-infographic.png" alt="GrokLink OS 3.9.0 Field Card product infographic" width="100%"/>
</p>

<p align="center">
  <img src="docs/assets/architecture-infographic.jpg" alt="GrokLink OS 3.9.0 Field Card architecture" width="100%"/>
</p>
...
# or: qFlipper-cli firmware path\to\GrokLink-OS-v3.9.0-radio.dfu
```
